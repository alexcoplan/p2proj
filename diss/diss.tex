...
effectiveness of muscial models. A recurrent neural network, at one extreme, is
...
Chatper~\ref{chap:eval} will discsuss the design and implementation of the
...
research, it was decided that the Python pacakge \texttt{music21} would be
...
maximum hisory $\hbar$.  Such a model can be thought of as a combination of
