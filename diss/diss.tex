...
\subsection{Combining Viewpoint Predictions}
...
an exponential bias $b \in \mathbb{R}$ with $b \geq 0$:
$$ w_i = \hat{H}(i)^{-b}. $$
...
$D$ has much lower entropy, it has considerbaly more effect on the overall
...
\todo Explain long- and short-term model briefly, perhaps mention symmetry with
LSTM, include figure of \textbf{typical} MVS architecture, maybe briefly touch
on hyperparams and constraints, done.
