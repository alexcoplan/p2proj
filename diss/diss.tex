...
project. The most relevant among these were Information Theory, Artifical
...
\end{align*}
where $f_1$ is representative of directly performing a geometric cominbation of
...
\times [\mathrm{keysig}] \times [\mathrm{timesig}] $$
which gives us an entirely local representaiton, with $[\mathrm{rest}]$ being a
