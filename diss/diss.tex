...
the human-readable nature of the format, so as to simplifying the debugging
...
database of examples and then uses an inference procedure to perform contextual
prediction.
